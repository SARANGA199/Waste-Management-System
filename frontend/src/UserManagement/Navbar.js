        ...
        return(
            <>
                ...
                <Link to="/profiles">
                    ...
                    <Link to="/profiles">
                        <li className="nav-item nav-link text-white " style={{marginRight:'5vh',marginLeft:'39vh'}}>
                            Driver Register
                        </li>
                    </Link>
                    <Link to="/profiles">
                    ...
                    <div class="m-b-25"> <img src={user.image} class="rounded-circle" width="50" alt="User-Profile-Image"/> </div>
                    <li class="nav-item">
                <button type="button"
