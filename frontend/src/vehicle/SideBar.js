...
<div class="dropdown">
  ...
  <ul class="dropdown-menu" aria-labelledby="dropdownMenu2">
  <li><a  href={"/staffdisp"} style={{width:"124.7%", marginLeft:"-24.8%"}} className="btn-secondary "> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Staff Member </a> </li>
  <li><a  href={"/srecord"} style={{width:"124.7%", marginLeft:"-24.8%"}} className="btn-secondary "> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Staff Record </a> </li>
  <li><a  href={"/staffattend"} style={{width:"124.7%", marginLeft:"-24.8%"}} className="btn-secondary "> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Attendance </a> </li>
