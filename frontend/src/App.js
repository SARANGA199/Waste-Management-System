...
function App() {
  return (
    <Router>
      ...
      <PrivateRoute path="/addRequest" roles={["admin","User"]} exact component={AddRequest} />
      <PrivateRoute path="/UpdateRequest" roles={["admin","User"]} exact component={UpdateRequest} />
      <PrivateRoute path="/dashboard" roles={["admin","User"]} exact component={Dashboard} />
      <PrivateRoute path="/deleteRequest" roles={["admin","User"]} exact component={DeleteRequest} />
      <PrivateRoute path="/itemlist" roles={["admin","User"]} exact component={ItemList} />
